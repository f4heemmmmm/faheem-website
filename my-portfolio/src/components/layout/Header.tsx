        ...
        <header className = "fixed top-0 left-0 w-full z-50 bg-gray-800 text-white shadow-md">
            <div className = "container mx-auto flex items-center justify-between py-4 px-6 md:px-12">
                ...
                <nav className = "hidden md:flex gap-8 text-md font-semibold">
                    ...
                    <button className="nav-link text-white hover:text-white focus:ring-0" onClick={() => document.getElementById("about")?.scrollIntoView({ behavior: "smooth" })}> about me </button>
                    <button className="nav-link text-white hover:text-white focus:ring-0" onClick={() => document.getElementById("experience")?.scrollIntoView({ behavior: "smooth" })}> experience </button>
                    <button className="nav-link text-white hover:text-white focus:ring-0" onClick={() => document.getElementById("skills")?.scrollIntoView({ behavior: "smooth" })}> skills </button>
                    <button className="nav-link text-white hover:text-white focus:ring-0" onClick={() => document.getElementById("contact")?.scrollIntoView({ behavior: "smooth" })}> contact me! </button>
                </nav>
